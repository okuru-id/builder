...
<template>
  <div class="p-8">
    <Button variant="ghost" size="sm" class="mb-4 -ml-2" @click="router.push('/admin/posts')">
    ...
    <form v-else class="grid max-w-3xl gap-4" @submit.prevent="save">
      ...
      <div class="flex gap-2">
        ...
        <Button type="button" variant="ghost" @click="router.push('/admin/posts')">Cancel</Button>
      </div>
    </form>
  </div>
</template>
